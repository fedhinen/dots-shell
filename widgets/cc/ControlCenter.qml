...
PanelWindow {
    ...
    implicitWidth: 320
    implicitHeight: contentCol.implicitHeight + 16 * 2
    color: "transparent"
    ...
    Process {
        ...
        command: action === "get" ? ["tuned-adm", "active"] : ["tuned-adm", "profile", action]
        stdout: SplitParser {
            onRead: function (line) {
                if (powerProc.action !== "get" || !line.includes("profile:"))
                    return;
                let p = line.split(":")[1].trim();
                cc.powerProfile = p.includes("powersave") || p.includes("battery") ? "power-saver" : p.includes("performance") ? "performance" : "balanced";
            }
        }
    }
    ...
    function setPowerProfile(profile) {
        ...
        powerProc.action = profile === "power-saver" ? "laptop-battery-powersave" : profile === "performance" ? "throughput-performance" : "balanced";
    ...
    Process {
        ...
        command: turnOn ? ["sh", "-c", "pkill gammastep 2>/dev/null; sleep 0.2; gammastep -P -O 4500 &"] : ["sh", "-c", "pkill gammastep 2>/dev/null; sleep 0.2; gammastep -x 2>/dev/null"]
    }
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Rectangle {
                Layout.fillWidth: true
                Layout.fillHeight: true
                color: showStatsInPanel ? "#3a3a3c" : "#2c2c2e"
                radius: 20
                Behavior on color {
                    ColorAnimation {
                        duration: 150
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Text {
                            ...
                            font.pixelSize: 16
                            color: cpuUsage > 80 ? "#ff453a" : "#007aff"
                        }
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                Text {
                                    ...
                                    color: cpuUsage > 80 ? "#ff453a" : "#ffffff"
                                }
                                ...
                                Text {
                                    ...
                                    font.family: "SF Pro Display, Inter, Cantarell, sans-serif"
                                    font.pixelSize: 12
                                    color: cpuTemp > 80 ? "#ff453a" : "#999999"
                                }
                            }
                        }
                    }
                    ...
                    RowLayout {
                        ...
                        Text {
                            ...
                            font.family: "Symbols Nerd Font"
                            font.pixelSize: 16
                            color: ramUsage > 80 ? "#ff453a" : "#007aff"
                        }
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                Text {
                                    ...
                                    font.pixelSize: 14
                                    font.weight: Font.Bold
                                    color: ramUsage > 80 ? "#ff453a" : "#ffffff"
                                }
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    Layout.fillHeight: true
                    radius: 20 - 4
                    color: powerProfile === "power-saver" ? "#007aff" : "transparent"
                    Behavior on color {
                        ColorAnimation {
                            duration: 150
                        }
                    ...
                    RowLayout {
                        ...
                        Text {
                            ...
                            font.family: "Symbols Nerd Font"
                            font.pixelSize: 14
                            color: powerProfile === "power-saver" ? "#ffffff" : "#bbbbbb"
                        }
                ...
                Rectangle {
                    ...
                    Layout.fillHeight: true
                    radius: 20 - 4
                    color: powerProfile === "balanced" ? "#007aff" : "transparent"
                    Behavior on color {
                        ColorAnimation {
                            duration: 150
                        }
                    ...
                    RowLayout {
                        ...
                        Text {
                            ...
                            font.family: "Symbols Nerd Font"
                            font.pixelSize: 14
                            color: powerProfile === "balanced" ? "#ffffff" : "#bbbbbb"
                        }
                ...
                Rectangle {
                    ...
                    Layout.fillHeight: true
                    radius: 20 - 4
                    color: powerProfile === "performance" ? "#007aff" : "transparent"
                    Behavior on color {
                        ColorAnimation {
                            duration: 150
                        }
                    ...
                    RowLayout {
                        ...
                        Text {
                            ...
                            font.family: "Symbols Nerd Font"
                            font.pixelSize: 14
                            color: powerProfile === "performance" ? "#ffffff" : "#bbbbbb"
                        }
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                Layout.fillHeight: true
                radius: 20
                color: nightLightActive ? "#cc8800" : "#2c2c2e"  // Warm amber when active
                Behavior on color {
                    ColorAnimation {
                        duration: 150
                    }
                ...
                RowLayout {
                    ...
                    Text {
                        ...
                        font.family: "Symbols Nerd Font"
                        font.pixelSize: 18
                        color: nightLightActive ? "#fff5e0" : "#999999"  // Warm white when active
                    }
                    ...
                    Text {
                        ...
                        font.pixelSize: 12
                        font.weight: Font.Medium
                        color: nightLightActive ? "#fff5e0" : "#ffffff"  // Warm white when active
                    }
                }
            ...
            Rectangle {
                ...
                Layout.fillHeight: true
                radius: 20
                color: lockMa.containsMouse ? Qt.rgba(1, 1, 1, 0.15) : "#2c2c2e"
                Behavior on color {
                    ColorAnimation {
                        duration: 100
                    }
