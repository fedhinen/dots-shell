...
`]
    ...
    Process {
        ...
        command: ["busctl", "set-property", "org.freedesktop.NetworkManager", "/org/freedesktop/NetworkManager", "org.freedesktop.NetworkManager", "WirelessEnabled", "b", targetState ? "true" : "false"]
        onExited: {
            root._stableCount = 0;
